...
import org.easyj.poi.excel.annotation.ExcelCells;
import org.easyj.poi.excel.style.ExcelFormats;
...
public class ExcelCellMapping {
	...
	private static int getCellWidthByText(String text, int size, boolean isBold) {
		int textLength = org.easyj.core.util.StringUtils.getStrLength(text);
