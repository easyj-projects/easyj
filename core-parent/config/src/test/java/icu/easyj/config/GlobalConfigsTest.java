...
public class GlobalConfigsTest {
	...
	public void testSetAndGetGlobalConfigs() {
		...
		// case: Run Mode
		// RELEASE Mode
		GlobalConfigs.setRunMode(RunMode.RELEASE);
		...
		// DEBUG Mode
		GlobalConfigs.setRunMode(RunMode.DEBUG);
		...
		GlobalConfigs.setInUnitTest(true);
		Assertions.assertTrue(GlobalConfigs.isInUnitTest());
		GlobalConfigs.setInUnitTest(false);
		Assertions.assertFalse(GlobalConfigs.isInUnitTest());
		...
		GlobalConfigs.addConfigs(configMap);
